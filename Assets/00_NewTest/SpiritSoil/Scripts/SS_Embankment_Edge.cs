...
public class SS_Embankment_Edge : MonoBehaviour
{
    ...
    public void UpdateModel()
    {
        ...
        bool down_Self = manager.SpiritSoilCheck(coord + Vector3Int.down, ID) && manager.spiritSoilDic[coord + Vector3Int.down].rotation == rotation;
        bool down_Ground = manager.SpiritSoilCheck(coord + Vector3Int.down, "Ground");
        bool down_Corner_0 = manager.SpiritSoilCheck(coord + Vector3Int.down, "Stone_InnerCorner") && manager.spiritSoilDic[coord + Vector3Int.down].rotation == SpiritSoilManager.RotateRotation(rotation, 3);
        bool down_Corner_1 = manager.SpiritSoilCheck(coord + Vector3Int.down, "Stone_InnerCorner") && manager.spiritSoilDic[coord + Vector3Int.down].rotation == rotation;
